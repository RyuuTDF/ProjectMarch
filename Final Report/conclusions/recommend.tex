...
Since another member of the Project MARCH team has created a simple 3D-model of the MARCH which can be controlled using a Simulink connection, connecting this model to the data receiver is would be advised compared to trying to integrate this model in the GUI, as this will likely cause performance problems.
