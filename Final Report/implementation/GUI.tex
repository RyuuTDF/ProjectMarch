...
In this sprint, the first iteration of the user interface was developed, first a character user interface as described in section \ref{sec:CUI} and following a graphical user interface as described in section \ref{sec:GUIS1}. The limitations found while developing the interface are discussed in section \ref{sec:LimS1}.
...
In this sprint the graphical user interface was refined. The implementation of more visualisation functionality is discussed in section \ref{sec:VisS3}. The implementation of additional control tools in the interface is discussed in section \ref{sec:ConS3}. The limitations found in the implementation of this sprint is found in section \ref{sec:LimS3}.
...
In this sprint the graphical user interface was finished. The performance issues and the solution for them is discussed in section \ref{sec:PerfS4}. The last additions to the interface are discussed in section \ref{sec:GUIS4}. 
